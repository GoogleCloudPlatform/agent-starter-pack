...
def create(
    ...
    try:
        ...
        requires_data_ingestion = (
            config and config.get("settings", {}).get("requires_data_ingestion")
        )
        ...
        if include_data_ingestion:
            console.print(
                f"   [bold bright_green]cd {cd_path} && make install[/]"
            )
            console.print(
                f"   [bold bright_green]make setup-datastore[/]"
            )
            console.print(
                f"   [bold bright_green]make data-ingestion[/]"
            )
            console.print(
                f"   [bold bright_green]make {interactive_command}[/]"
            )
        else:
            console.print(
