...
def copy_sample_data_files(project_template: pathlib.Path) -> None:
    ...
    if sample_data_src.exists():
        ...
        logging.warning(
            f"Sample data source directory not found at {sample_data_src}"
        )
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            if include_data_ingestion and datastore == "vertex_ai_search":
                logging.debug(
                    "3. Including sample data files for vertex_ai_search"
                )
            ...
            if agent_path.exists():
                ...
                other_folders = ["frontend", "tests", "notebooks", "deployment", "data_ingestion"]
