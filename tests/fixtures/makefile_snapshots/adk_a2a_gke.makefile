...
deploy:
	...
	gcloud container clusters get-credentials test-a2a-dev --region us-west1 --project $$PROJECT_ID && \
	IMAGE_TAG=$${IMAGE_TAG:-$$(date +%Y%m%d%H%M%S)} && \
	IMAGE=us-west1-docker.pkg.dev/$$PROJECT_ID/test-a2a/test-a2a:$$IMAGE_TAG && \
