...
local-backend:
	uv run uvicorn test_garden.fast_api_app:app --host localhost --port $(or $(PORT),8000) --reload
...
eval:
	...
	uv run adk eval ./test_garden $${EVALSET:-tests/eval/evalsets/basic.evalset.json}
