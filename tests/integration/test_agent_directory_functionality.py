...
class TestAgentDirectoryFunctionality:
    ...
    def test_create_with_custom_agent_directory_via_remote_template(self):
...
'''
    ...
    def test_enhance_with_custom_agent_directory_cli_param(self):
...
""")
    ...
    def test_enhance_uses_agent_directory_from_pyproject(self):
